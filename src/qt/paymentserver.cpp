...
const QString BITCOIN_IPC_PREFIX("somacoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click somacoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start somacoin: click-to-pay handler");
    else
...
{
    // clicking on somacoin: URLs creates FileOpen events on the Mac:

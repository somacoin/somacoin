...
// Copyright (c) 2013 The Somacoin developers
...
uint256 hashGenesisBlock("0x000005c1648a529a9d13c5a44edd0ae999c63d151d320c0cdfde378aa4a3a6d2");
...
const string strMessageMagic = "Somacoin Signed Message:\n";
...
static const int64 nTargetTimespan = 120; //SOMA: 12 * 60 * 60; // 12 hours
static const int64 nTargetSpacing = 60; //SOMA: 60 seconds
...
int64 static GetBlockValue(int nHeight, int64 nFees, unsigned int nBits)
{
    ...
    nSubsidy >>= (nHeight / 200000); // Reward halves every 200,000 blocks
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x710759cda87ddbc674869c7563c7d6a9d95904071501f0b526386bfedcd2ecc2");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "24 January 2014 Opportunity discovers conditions for life on Mars";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 112;
        block.nTime    = 1390742261;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1588183;
        ...
        assert(block.hashMerkleRoot == uint256("0x710759cda87ddbc674869c7563c7d6a9d95904071501f0b526386bfedcd2ecc2"));
        block.print();
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("SomacoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("SomacoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("SomacoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("somacoin-miner");
    ...
    try { loop {
        ...
        printf("Running SomacoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("SomacoinMiner terminated\n");
        throw;
    }
}

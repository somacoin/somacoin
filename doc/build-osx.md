...
See `doc/readme-qt.rst` for instructions on building SOMA-Qt, the
...
A bitcoind binary is not included in the SOMA-Qt.app bundle. You can ignore
...
on an OS X 10.6 64-bit machine fails. Official release builds of SOMA-Qt are
compiled on an OS X 10.6 32-bit machine to workaround that problem.

Once dependencies are compiled, creating `SOMA-Qt.app` is easy:

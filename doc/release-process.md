...
**Perform Mac build:**
  ...
  OSX binaries are created by Gavin Andresen on a 32-bit, OSX 10.6 machine.
	...
	python2.7 contrib/macdeploy/macdeployqtplus SOMA-Qt.app -add-qt-tr $T -dmg -fancy contrib/macdeploy/fancy.plist

 Build output expected: SOMA-Qt.dmg

###Next steps:

* Code-sign Windows -setup.exe (in a Windows virtual machine) and
  OSX SOMA-Qt.app (Note: only Gavin has the code-signing keys currently)
